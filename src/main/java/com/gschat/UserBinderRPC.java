 ...
 */
public final class UserBinderRPC {
    ...
    public UserBinderRPC(com.gsrpc.Channel net, short serviceID){
        this.net = net;
        this.serviceID = serviceID;
    }

    public UserBinderRPC(com.gsrpc.Channel net) throws Exception {
        this.net = net;
        this.serviceID = com.gsrpc.Register.getInstance().getID(UserBinder.NAME);
    }

    
    public com.gsrpc.Future<Void> bindUser(String arg0, Device arg1, final int timeout) throws Exception {
    ...
    public com.gsrpc.Future<Void> unbindUser(String arg0, Device arg1, final int timeout) throws Exception {
